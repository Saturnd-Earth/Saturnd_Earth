...
RSpec.describe Like, type: :model do
  ...
  describe "creation" do
    it "can create a like" do
      ...
      post = Post.create!(user_id: user1.id, text: "Insert funny joke here.", latitude: 40.3456, longitude: -120.2345, post_type: "Comment")
  ...
  describe "model methods" do
    it "can increase a post's ring size if like is inside ring" do
      user1 = User.create!(username: "johndoe", password: "123", password_confirmation: '123')
      user2 = User.create!(username: "bobbybones", password: "123", password_confirmation: '123')
      Post.create!(user_id: user1.id, text: "Insert funny joke here.", latitude: 32.6926315, longitude: -97.1486855, ring_min_max: 10, post_type: "Comment")
      post = Post.first
